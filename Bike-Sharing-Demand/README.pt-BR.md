...
`multilang`. A edição EN-US foi concluída após tradução editorial, revisão
técnica e validação de execução dos oito notebooks.
...
| Notebook | PT-BR | EN-US | Natureza |
|---|---|---|---|
| 01 — EDA 2015–2024 | [PT-BR](notebooks/pt-BR/01_Seoul_Bike_2015-2024_EDA.ipynb) | [EN-US](notebooks/en-US/01_Seoul_Bike_2015-2024_EDA.ipynb) | Descritiva |
| 02 — Análise multivariada | [PT-BR](notebooks/pt-BR/02_Seoul_Bike_Multivariate_Analysis.ipynb) | [EN-US](notebooks/en-US/02_Seoul_Bike_Multivariate_Analysis.ipynb) | Descritiva |
| 03 — Engenharia de atributos | [PT-BR](notebooks/pt-BR/03_Feature_Engineering_EDA.ipynb) | [EN-US](notebooks/en-US/03_Feature_Engineering_EDA.ipynb) | Descritiva |
| 04 — Seleção de modelos | [PT-BR](notebooks/pt-BR/04_Seoul_Bike_Model_Selection.ipynb) | [EN-US](notebooks/en-US/04_Seoul_Bike_Model_Selection.ipynb) | Seleção |
| 05 — Validação final | [PT-BR](notebooks/pt-BR/05_Seoul_Bike_Final_Validation.ipynb) | [EN-US](notebooks/en-US/05_Seoul_Bike_Final_Validation.ipynb) | Confirmatória |
| 06 — Resíduos e incerteza | [PT-BR](notebooks/pt-BR/06_Seoul_Bike_Residual_and_Uncertainty_Experiments.ipynb) | [EN-US](notebooks/en-US/06_Seoul_Bike_Residual_and_Uncertainty_Experiments.ipynb) | Experimental |
| 07 — Calibração conformal | [PT-BR](notebooks/pt-BR/07_Seoul_Bike_Temporal_Conformal_Calibration.ipynb) | [EN-US](notebooks/en-US/07_Seoul_Bike_Temporal_Conformal_Calibration.ipynb) | Experimental |
| 08 — Demonstração operacional | [PT-BR](notebooks/pt-BR/08_Seoul_Bike_Operational_Forecast_Demo.ipynb) | [EN-US](notebooks/en-US/08_Seoul_Bike_Operational_Forecast_Demo.ipynb) | Demonstração |
...
| `notebooks/pt-BR/` | Edição canônica em português do fluxo analítico de oito etapas |
| `notebooks/en-US/` | Edição equivalente em inglês, revisada e validada por execução |
...
e a incorporação de uma nova janela temporal pública.
